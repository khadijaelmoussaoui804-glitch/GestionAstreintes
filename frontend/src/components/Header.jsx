      ...
      <div className="header-content">
        ...
        <div className="header-user flex items-center gap-4">
                      ...
                      <div key={notif.id}
                        ...
                        <div className="flex gap-3">
                          {notif.avatar
                            ...
                            : <div className="w-8 h-8 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center font-bold">{notif.initials || '🔔'}</div>
                          }
                          <div className="flex-1">
                            ...
                            <span className="text-xs text-gray-400 mt-2 block">{new Date(notif.timestamp).toLocaleString('fr-FR')}</span>
                          </div>
          ...
          <div className="header-admin-badge">
            ...
            <span style={{ fontWeight: 600, color: '#1e293b' }}>{user?.name || 'Sami B.'}</span>
